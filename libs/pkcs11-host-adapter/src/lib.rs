...
pub mod bindings {
    wit_bindgen::generate!({
        ...
        generate_all,
        path: [
            "../pkcs11-wit/pkcs11-buffer/buffer.wit",
            "../pkcs11-wit/pkcs11-core/core.wit",
            "../pkcs11-wit/pkcs11-crypto/crypto.wit",
            "../pkcs11-wit/pkcs11-object/object.wit",
            "../pkcs11-wit/pkcs11-util/util.wit",
            "../pkcs11-wit/pkcs11-session/session.wit",
            "../pkcs11-wit/pkcs11-token/slot-manager.wit",
            "../pkcs11-wit/pkcs11-registry/provider-registry.wit",
            "../pkcs11-wit/worlds/pkcs11.wit",
        ],
    });
}
